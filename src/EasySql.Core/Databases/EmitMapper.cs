...
//        public static IEnumerable<T> Map<T>(DbDataReader dataReader)
//        {
...
//                foreach (PropertyInfo pi in typeof(T).GetProperties().Where(x => x.CanWrite))
//                {
...
//                yield return invokeMapEntity(dataReader);
//        }
